...
class ExpandableCardView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : LinearLayout(context, attrs, defStyleAttr) {
    ...
    private fun initView(context: Context) {
        //Inflating View
        LayoutInflater.from(context).inflate(R.layout.layout_expandable_cardview, this)
    }
    ...
    override fun onFinishInflate() {
        ...
        iconDrawable?.let { drawable ->
            card_header_expandable_view.visibility = View.VISIBLE
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            elevation = Convert.dpToPixels(context, 4f)
    ...
    fun setHeaderMarginLeft(marginLeft: Int) {
        headerMarginLeft = marginLeft
    }
