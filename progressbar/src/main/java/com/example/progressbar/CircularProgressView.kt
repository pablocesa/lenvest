...
class CircularProgressView : View {
    companion object {
        ...
        const val PROGRESS_HOLDER_COLOR_TYPE_DEFAULT = 0
        const val PROGRESS_HOLDER_COLOR_TYPE_CUSTOM = 1
        ...
        private const val KEY_PROGRESS_HOLDER_COLOR_TYPE = "KEY_PROGRESS_HOLDER_COLOR_TYPE"
    ...
    private var progressHolderColor: Int = 0
    private var progressHolderColorType: Int = PROGRESS_HOLDER_COLOR_TYPE_DEFAULT
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        if (attrs != null) {
            ...
            progressHolderColor = typedArray.getColor(R.styleable.CircularProgressView_progressColor, 0)
            ...
            progressHolderColorType = typedArray.getInt(R.styleable.CircularProgressView_progressHolderColorType, PROGRESS_HOLDER_COLOR_TYPE_DEFAULT)
            ...
            if (progressHolderColorType == PROGRESS_HOLDER_COLOR_TYPE_DEFAULT){
                progressHolderColor = adjustAlpha(progressColor, 0.3f)
            }
    ...
    private fun setupPaint() {
        ...
        paintTotal.color = progressHolderColor
    ...
    fun setTotalColor(color: Int) {
        this.progressHolderColor = color
        paintTotal.color = this.progressHolderColor
        invalidate()
    }

    fun setTotalColorRes(@ColorRes colorRes: Int) {
        this.progressHolderColor = ContextCompat.getColor(context, colorRes)
        paintTotal.color = this.progressHolderColor
        invalidate()
    }
    ...
    override fun onSaveInstanceState(): Parcelable? {
        ...
        bundle.putInt(KEY_TOTAL_COLOR, progressHolderColor)
        ...
        bundle.putInt(KEY_PROGRESS_HOLDER_COLOR_TYPE, progressHolderColorType)
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        if (state is Bundle) {
            ...
            progressHolderColor = state.getInt(KEY_TOTAL_COLOR)
            ...
            progressHolderColorType  = state.getInt(KEY_PROGRESS_HOLDER_COLOR_TYPE)
